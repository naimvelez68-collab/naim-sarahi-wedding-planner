...
// ─── Guests — Lista real desde BODA.xlsx ────────────────────────────────────
export const seedGuests: Guest[] = [
  // ── Familia directa Novio ─────────────────────────────────────────────────
  g('Juan Carlos Vélez',       'groom_family', 'pending',   null,            'tb04', false, false, 'Familia directa'),
  g('María Isabel Posada',     'groom_family', 'pending',   null,            'tb04'),
  g('Juan José Vélez',         'groom_family', 'confirmed', 'Angie Calderón','tb04'),
  g('Carlos Vélez',            'groom_family', 'pending',   null,            'tb04'),
  g('Margoth Riofrío',         'groom_family', 'pending',   null,            'tb04'),
  g('Amparo Quintero',         'groom_family', 'pending',   null,            'tb04'),
  g('Ángela Posada',           'groom_family', 'confirmed', null,            'tb04'),
  g('Claudia Moreno',          'groom_family', 'confirmed', null,            'tb04'),
  g('Evelyn Vélez',            'groom_family', 'confirmed', null,            'tb04'),
  g('Sandra Riofrío',          'groom_family', 'pending',   null,            'tb05'),
  g('Vladimir Bazante',        'groom_family', 'pending',   null,            'tb05'),
  g('Juan José Bazante',       'groom_family', 'confirmed', 'Acompañante',  'tb05'),
  g('Joshua Bazante',          'groom_family', 'confirmed', 'Acompañante',  'tb05'),
  g('Pamela Bazante',          'groom_family', 'confirmed', 'Jacques Simon','tb05'),
  g('Vladimir Bazante R.',     'groom_family', 'confirmed', 'Acompañante',  'tb05'),
  g('Luis Fernando',           'groom_family', 'confirmed', null,            'tb05', false, false, '📸 Fotógrafo y videógrafo — primo de Naim (gratis)'),
  g('María Fernanda Molina',   'groom_family', 'confirmed', 'Inti Molina',   'tb05'),
  g('Lucciana Gallegos',       'groom_family', 'pending',   null,            null),
  g('Alexander Molina',        'groom_family', 'confirmed', null,            'tb05'),
  g('Juan Manuel Molina',      'groom_family', 'confirmed', null,            'tb05'),
  // ── Familia extendida Novio ───────────────────────────────────────────────
  g('Olga Lara',               'groom_family', 'pending',   null,            'tb06', true),
  g('María Fernanda Haro',     'groom_family', 'confirmed', 'Geovanny Andrade','tb06'),
  g('Valentina Andrade',       'groom_family', 'confirmed', null,            'tb06'),
  g('Mateo Andrade',           'groom_family', 'pending',   null,            'tb06'),
  g('Lupe Eguez',              'groom_family', 'confirmed', null,            'tb06', true),
  g('David Illingworth',       'groom_family', 'confirmed', 'Por revisar',  'tb06'),
  g('Pepe Vélez',              'groom_family', 'confirmed', 'Por revisar',  'tb06'),
  g('Susana (tía)',             'groom_family', 'confirmed', 'Por revisar',  'tb06', true),
  ...
  g('Ricardo Riofrío',         'groom_family', 'confirmed', null,            'tb06'),
  g('Bianca Vélez',            'groom_family', 'confirmed', 'Acompañante',  'tb06'),
  g('Andrés Vaca',             'groom_family', 'confirmed', 'Acompañante',  'tb06'),
  // ── Familia directa Novia ─────────────────────────────────────────────────
  g('Renán Guevara',           'bride_family', 'pending',   null,            'tb02'),
  g('Mónica Ibarra',           'bride_family', 'pending',   null,            'tb02'),
  g('Flor Gaibor',             'bride_family', 'pending',   null,            'tb02'),
  g('Arely Guevara',           'bride_family', 'pending',   'Miguel Rocha', 'tb02'),
  ...
  g('Byron Ibarra',            'bride_family', 'pending',   null,            'tb03'),
  ...
  g('Xavier',                  'church',       'confirmed', null,            'tb07'),
  g('María Eugenia',           'church',       'confirmed', null,            'tb07'),
  g('José (iglesia)',          'church',       'confirmed', null,            'tb07'),
  g('Mathías',                 'church',       'pending',   null,            'tb07'),
  g('Klever',                  'church',       'confirmed', 'Mujer',         'tb07'),
  g('Malena',                  'church',       'pending',   null,            'tb07'),
  g('Teresa',                  'church',       'pending',   null,            null),
  g('Abby',                    'church',       'pending',   null,            null),
  g('Diego (iglesia)',         'church',       'confirmed', null,            null),
  g('Elena (iglesia)',         'church',       'confirmed', null,            null),
  g('Baterista',               'church',       'pending',   null,            null, false, false, 'Músico de iglesia'),
  // ── Amigos íntimos ────────────────────────────────────────────────────────
  g('Mateo Bracho',            'friends',      'confirmed', 'Acompañante',  'tb08'),
  g('Estefi Erazo',            'friends',      'confirmed', 'Acompañante',  'tb08'),
  g('Rebe / Pau',              'friends',      'confirmed', null,            'tb08'),
  g('Alejandro López',         'friends',      'confirmed', 'Acompañante',  'tb08'),
  g('Fabián Urresta',          'friends',      'confirmed', 'Acompañante',  'tb08'),
  g('Joyce Baus',              'friends',      'confirmed', null,            'tb08'),
  g('Jeremy',                  'friends',      'confirmed', 'Acompañante',  'tb09'),
  g('Alemán 1',                'friends',      'confirmed', null,            'tb09'),
  g('Alemán 2',                'friends',      'confirmed', null,            'tb09'),
  g('Jaime Orquera',           'friends',      'confirmed', 'Vanessa',       'tb09'),
  g('Mijael',                  'friends',      'confirmed', null,            'tb09'),
  g('Susy',                    'friends',      'confirmed', null,            'tb09'),
  g('Kandy Jaramillo',         'friends',      'confirmed', 'Acompañante',  'tb09'),
  g('Mayra Ormaza',            'friends',      'confirmed', 'Acompañante',  'tb09'),
  // ── Compromiso ────────────────────────────────────────────────────────────
  g('Nancy Andrade',           'other',        'confirmed', null,            'tb10'),
  g('Petronio Calderón',       'other',        'confirmed', null,            'tb10'),
  g('Fabrizio Celleri',        'other',        'pending',   null,            'tb10'),
  g('Alejandra Cereceda',      'other',        'pending',   null,            'tb10'),
  // ── Sin categoría / pendiente ─────────────────────────────────────────────
  g('Greys Herrera',           'friends',      'confirmed', 'Acompañante',  'tb10'),
  g('Rayner',                  'friends',      'confirmed', 'Acompañante',  'tb10'),
  g('José Suing',              'other',        'confirmed', 'Acompañante',  'tb11'),
  g('Gaby Acosta',             'other',        'confirmed', 'Acompañante',  'tb11'),
  g('Sofy Velasco',            'other',        'pending',   null,            'tb11'),
  g('Jaqueline Viteri',        'other',        'pending',   null,            'tb11'),
  g('Nicole Ruiz',             'other',        'pending',   'Acompañante',  null),
  g('Diana Viteri',            'other',        'pending',   'Acompañante',  null),
  g('Erick Tigse',             'other',        'pending',   'Acompañante',  null),
  g('Joel Solís',              'other',        'pending',   null,            null),
  g('Ángel Túnala',            'other',        'pending',   null,            null),
]

// ─── Budget — $2,000–$2,500 total ───────────────────────────────────────────
// 130 personas estimadas · Fotografía GRATIS (Luis Fernando)
export const seedBudget: BudgetItem[] = [
  {
    id: uid(), concept: 'Plato principal — Moro con carne',
    category: 'food', estimatedAmount: 877, realAmount: 877, paidAmount: 0,
    status: 'pending', priority: 'mandatory', dueDate: '2026-08-01',
    vendorId: null, notes: '$6.75/persona × 130 personas', receipt: '', createdAt: t, updatedAt: t,
  },
  {
    id: uid(), concept: 'Postre — Mousse / flan / copa',
    category: 'food', estimatedAmount: 163, realAmount: 163, paidAmount: 0,
    status: 'pending', priority: 'mandatory', dueDate: '2026-08-01',
    vendorId: null, notes: '$1.25/persona × 130 — total plato: $8/persona (dentro del presupuesto)', receipt: '', createdAt: t, updatedAt: t,
  },
  {
    id: uid(), concept: 'Mesa de bocaditos variados',
    category: 'bocaditos', estimatedAmount: 200, realAmount: 200, paidAmount: 0,
    status: 'pending', priority: 'important', dueDate: '2026-08-05',
    vendorId: null, notes: 'Bocaditos dulces + salados para mesa de autoservicio', receipt: '', createdAt: t, updatedAt: t,
  },
  {
    id: uid(), concept: 'Mesa de pizza',
    category: 'bocaditos', estimatedAmount: 80, realAmount: 80, paidAmount: 0,
    status: 'pending', priority: 'important', dueDate: '2026-08-07',
    vendorId: null, notes: '5-6 pizzas grandes para mesa de autoservicio', receipt: '', createdAt: t, updatedAt: t,
  },
  {
    id: uid(), concept: 'Cervezas (150 latas Pilsener)',
    category: 'beverages', estimatedAmount: 113, realAmount: 113, paidAmount: 0,
    status: 'pending', priority: 'important', dueDate: '2026-08-06',
    vendorId: null, notes: '$0.75/lata × 150 — comprar en distribuidora por mayor', receipt: '', createdAt: t, updatedAt: t,
  },
  {
    id: uid(), concept: 'Mimosas (cava + jugo de naranja)',
    category: 'beverages', estimatedAmount: 130, realAmount: 130, paidAmount: 0,
    status: 'pending', priority: 'important', dueDate: '2026-08-06',
    vendorId: null, notes: '10 bot. cava económica ($8 c/u) + 10 L jugo naranja — aprox 100 copas', receipt: '', createdAt: t, updatedAt: t,
  },
  {
    id: uid(), concept: 'Tinto de verano',
    category: 'beverages', estimatedAmount: 65, realAmount: 65, paidAmount: 0,
    status: 'pending', priority: 'optional', dueDate: '2026-08-06',
    vendorId: null, notes: '8 bot. vino tinto económico + 8 L gaseosa limonada', receipt: '', createdAt: t, updatedAt: t,
  },
  {
    id: uid(), concept: 'Agua, gaseosas, jugos (sin alcohol)',
    category: 'beverages', estimatedAmount: 80, realAmount: 80, paidAmount: 0,
    status: 'pending', priority: 'mandatory', dueDate: '2026-08-06',
    vendorId: null, notes: 'Para niños, adultos mayores y quienes no toman alcohol', receipt: '', createdAt: t, updatedAt: t,
  },
  {
    id: uid(), concept: 'Hielo',
    category: 'beverages', estimatedAmount: 25, realAmount: 25, paidAmount: 0,
    status: 'pending', priority: 'mandatory', dueDate: '2026-08-07',
    vendorId: null, notes: '10 bolsas × $2.50 — comprar día anterior', receipt: '', createdAt: t, updatedAt: t,
  },
  {
    id: uid(), concept: 'DJ + Equipo de sonido',
    category: 'music', estimatedAmount: 350, realAmount: 350, paidAmount: 100,
    status: 'partial', priority: 'mandatory', dueDate: '2026-07-15',
    vendorId: null, notes: 'Anticipo $100 pagado. Playlist: Juan Luis Guerra, Carlos Vives, Fonseca', receipt: '', createdAt: t, updatedAt: t,
  },
  {
  ...
  {
    id: uid(), concept: 'Decoración del lugar',
    category: 'decoration', estimatedAmount: 150, realAmount: 150, paidAmount: 0,
    status: 'pending', priority: 'important', dueDate: '2026-07-20',
    vendorId: null, notes: 'Flores, centros de mesa, mantelería, globos, luces', receipt: '', createdAt: t, updatedAt: t,
  },
  {
    id: uid(), concept: 'Arreglos florales (ramo + iglesia)',
    category: 'decoration', estimatedAmount: 80, realAmount: 80, paidAmount: 0,
    status: 'pending', priority: 'important', dueDate: '2026-08-05',
    vendorId: null, notes: 'Ramo novia + decoración iglesia básica', receipt: '', createdAt: t, updatedAt: t,
  },
  {
  ...
  },
  {
    ...
    status: 'pending', priority: 'important', dueDate: '2026-08-05',
    vendorId: null, notes: 'Pastelería local Ibarra — 3 pisos para 130 personas', receipt: '', createdAt: t, updatedAt: t,
  },
  {
