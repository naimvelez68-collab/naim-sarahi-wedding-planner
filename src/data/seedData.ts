...
// ─── Guests — Lista actualizada 26-Jun-2026 ──────────────────────────────────
// Confirmados = BODA.xlsx · Por confirmar = invitados-2026-06-26.csv (sin duplicados)
export const seedGuests: Guest[] = [
  ...
  g('Vladimir Bazante',        'groom_family', 'confirmed', null,             'tb05'),
  ...
  g('Lucciana Gallegos',       'groom_family', 'confirmed', null,             null),
  ...
  g('Olga Lara',               'groom_family', 'confirmed', null,             'tb06', true),
  g('María Fernanda Haro',     'groom_family', 'confirmed', 'Geovanny Andrade','tb06'),
  g('Valentina Andrade',       'groom_family', 'confirmed', null,             'tb06'),
  g('Mateo Andrade',           'groom_family', 'confirmed', null,             'tb06'),
  g('Lupe Eguez',              'groom_family', 'confirmed', null,             'tb06', true),
  g('David Illingworth',       'groom_family', 'confirmed', 'Por confirmar',  'tb06'),
  g('Pepe Vélez',              'groom_family', 'confirmed', 'Por confirmar',  'tb06'),
  g('Susana (tía)',             'groom_family', 'confirmed', 'Por confirmar',  'tb06', true),
  g('Anita Riofrío',           'groom_family', 'confirmed', 'Guillo',         null),
  g('David Haro',              'groom_family', 'confirmed', 'Pareja',         null),
  g('Paola Haro',              'groom_family', 'confirmed', 'Pareja',         null),
  ...
  g('David Guevara',           'bride_family', 'confirmed', 'Anahis Santillán','tb02'),
  g('Renán P. Guevara',        'bride_family', 'confirmed', 'Gabriela Suquillo','tb02'),
  g('Paola Guevara',           'bride_family', 'confirmed', null,             'tb02'),
  g('Tannia Guevara',          'bride_family', 'confirmed', null,             'tb03'),
  g('Ana María Guevara',       'bride_family', 'confirmed', null,             'tb03'),
  g('Byron Ibarra',            'bride_family', 'confirmed', null,             'tb03'),
  g('Verónica Ibarra',         'bride_family', 'confirmed', null,             'tb03'),
  g('Elizabeth Ibarra',        'bride_family', 'confirmed', null,             'tb03'),
  g('Patricio Guevara',        'bride_family', 'confirmed', 'Lucy',           'tb03', true),
  // ── Iglesia ───────────────────────────────────────────────────────────────
  ...
  g('Mathías',                 'church',       'confirmed', null,             'tb07'),
  g('Klever',                  'church',       'confirmed', 'Mujer',          'tb07'),
  g('Malena',                  'church',       'confirmed', null,             'tb07'),
  g('Teresa',                  'church',       'confirmed', null,             null),
  g('Abby',                    'church',       'confirmed', null,             null),
  g('Diego (iglesia)',          'church',       'confirmed', null,             null),
  g('Elena (iglesia)',          'church',       'confirmed', null,             null),
  g('Baterista',               'church',       'confirmed', null,             null, false, false, 'Músico de iglesia'),
  // ── Amigos íntimos ────────────────────────────────────────────────────────
  ...
  g('Fabrizio Celleri',        'other',        'confirmed', null,             'tb10'),
  g('Alejandra Cereceda',      'other',        'confirmed', null,             'tb10'),
  // ── Otros confirmados ─────────────────────────────────────────────────────
  g('Gabriela Acosta',         'other',        'confirmed', 'Acompañante',    'tb11'),
  g('Jacqueline Viteri',       'other',        'confirmed', 'Acompañante',    'tb11'),
  g('Nicole Ruiz',             'other',        'confirmed', 'Acompañante',    null),
  ...
  // ── Por confirmar (CSV pero no en XLSX) ───────────────────────────────────
  g('Sofía Velasco',           'other',        'pending',   null,             'tb11'),
  g('Miguel Rocha',            'bride_family', 'pending',   null,             'tb02'),
  g('Carolina Olmedo',         'other',        'pending',   null,             null),
  g('Anahis Santillán',        'bride_family', 'pending',   null,             'tb02'),
  g('Estefanny Chávez',        'friends',      'pending',   null,             null),
]
